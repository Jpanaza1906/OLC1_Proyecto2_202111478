...
function Declaracion(_instruccion, _ambito){
    if (_instruccion.tipo_dato === TIPO_DATO.DECIMAL) { 
        ...
        if (_instruccion.valor != null) {
            ...
            tipo = op.tipo;
            if (tipo === TIPO_DATO.DECIMAL) {valor = op.valor; }
        }
        ...
        if (_instruccion.valor != null) { 
            var op = Operacion(_instruccion.valor, _ambito)
            tipo = op.tipo;
            if (tipo === TIPO_DATO.ENTERO) { valor = op.valor; }
        }
        ...
        if (_instruccion.valor != null) {
            var op = Operacion(_instruccion.valor, _ambito)
            tipo = op.tipo;
            if (tipo === TIPO_DATO.CHAR) { valor = op.valor; }
        }
        ...
        if (_instruccion.valor != null) {
            var op = Operacion(_instruccion.valor, _ambito)
            tipo = op.tipo;
            if (tipo === TIPO_DATO.BOOL) { valor = op.valor; }
        }
        ...
        if (_instruccion.valor != null) {
            var op = Operacion(_instruccion.valor, _ambito)
            tipo = op.tipo;
            if (tipo === TIPO_DATO.CADENA) { valor = op.valor; }
        }
